...
class View : public QMainWindow {
 ...
 private:
   ...
   * @return pointer to button
   */
  QPushButton* createGenCaveButton(QTextEdit* Rows, QTextEdit* Columns,
   ...
   * @return pointer to button
   */
  QPushButton* createCaveOneStepButton(QTextEdit* BirthLimit,
   ...
   * @return pointer to button
   */
  QPushButton* createCaveAutoButton(QTextEdit* BirthLimit,
                                    QTextEdit* DeathLimit, QTextEdit* timeEdit);
