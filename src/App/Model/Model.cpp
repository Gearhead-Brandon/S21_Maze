 ...
 */
OpResult Model::loadMaze(const std::string& path) { return maze_->load(path); }
 ...
 * @return Operation result
 */
OpResult Model::transformCave(bool full, int birthLimit, int deathLimit,
                              int time) {
 ...
 * @return Operation result
 */
OpResult Model::loadCave(const std::string& path) { return cave_->load(path); }
 ...
 */
void Model::clearPath() { maze_->clearPath(); }
